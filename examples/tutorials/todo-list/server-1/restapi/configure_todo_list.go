...
import (
	...
	"github.com/ianchen0119/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/ianchen0119/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
