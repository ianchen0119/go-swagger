...
func TestSchemaBuilder(t *testing.T) {
	...
	pn := "github.com/ianchen0119/go-swagger/fixtures/goparsing/classification/models"
	assert.True(t, ok)
...
func getClassificationModel(sctx *scanCtx, nm string) *entityDecl {
	decl, ok := sctx.FindDecl("github.com/ianchen0119/go-swagger/fixtures/goparsing/classification/models", nm)
	if !ok {
		return nil
	}
	return decl
