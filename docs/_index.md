...
To generate a [CLI for a swagger spec](https://github.com/ianchen0119/go-swagger/tree/master/examples/cli) document:
```
...
```
github.com/ianchen0119/go-swagger/httpkit/validate to github.com/go-openapi/validate
github.com/ianchen0119/go-swagger/httpkit to github.com/go-openapi/runtime
github.com/naoina/denco to github.com/go-openapi/runtime/middleware/denco
github.com/ianchen0119/go-swagger to github.com/go-openapi
```
